...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", type=str, default="", help="Path to the checkpoint to evaluate")
    ...
    # Evaluation
    if args.eval_path:
        print(f"Running evaluation on dataset: {args.eval_path}")
        if args.eval_L2:
        ...
        print("No evaluation path provided. Skipping evaluation.")
